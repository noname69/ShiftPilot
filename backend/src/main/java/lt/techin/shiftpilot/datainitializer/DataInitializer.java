...
//
//            List<Long> userIds1 = List.of(worker1.getId(), worker2.getId(), worker3.getId(), worker4.getId(), worker5.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds1), savedShift1.getId());
//
//            List<Long> userIds2 = List.of(worker2.getId(), worker3.getId(), worker4.getId(), worker5.getId(), worker6.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds2), savedShift2.getId());
//
//            List<Long> userIds3 = List.of(worker3.getId(), worker4.getId(), worker5.getId(), worker6.getId(), worker7.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds3), savedShift3.getId());
//
//            List<Long> userIds4 = List.of(worker4.getId(), worker5.getId(), worker6.getId(), worker7.getId(), worker8.getId(), worker9.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds4), savedShift4.getId());
//
//            List<Long> userIds5 = List.of(worker5.getId(), worker6.getId(), worker7.getId(), worker8.getId(), worker9.getId(), worker10.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds5), savedShift5.getId());
//
//            List<Long> userIds6 = List.of(worker6.getId(), worker7.getId(), worker8.getId(), worker9.getId(), worker10.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds6), savedShift6.getId());
//
//            List<Long> userIds7 = List.of(worker7.getId(), worker8.getId(), worker9.getId(), worker10.getId(), worker11.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds7), savedShift7.getId());
//
//            List<Long> userIds8 = List.of(worker8.getId(), worker9.getId(), worker10.getId(), worker11.getId(), worker12.getId(), worker13.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds8), savedShift8.getId());
//
//            List<Long> userIds9 = List.of(worker9.getId(), worker10.getId(), worker11.getId(), worker12.getId(), worker13.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds9), savedShift9.getId());
//
//            List<Long> userIds10 = List.of(worker10.getId(), worker11.getId(), worker12.getId(), worker13.getId(), worker14.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds10), savedShift10.getId());
//
//            List<Long> userIds11 = List.of(worker11.getId(), worker12.getId(), worker13.getId(), worker14.getId(), worker15.getId(), worker16.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds11), savedShift11.getId());
//
//            List<Long> userIds12 = List.of(worker12.getId(), worker13.getId(), worker14.getId(), worker15.getId(), worker16.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds12), savedShift12.getId());
//
//            List<Long> userIds13 = List.of(worker13.getId(), worker14.getId(), worker15.getId(), worker16.getId(), worker17.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds13), savedShift13.getId());
//
//            List<Long> userIds14 = List.of(worker14.getId(), worker15.getId(), worker16.getId(), worker17.getId(), worker18.getId(), worker19.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds14), savedShift14.getId());
//
//            List<Long> userIds15 = List.of(worker15.getId(), worker16.getId(), worker17.getId(), worker18.getId(), worker19.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds15), savedShift15.getId());
//
//            List<Long> userIds16 = List.of(worker16.getId(), worker17.getId(), worker18.getId(), worker19.getId(), worker20.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds16), savedShift16.getId());
//
//            List<Long> userIds17 = List.of(worker1.getId(), worker2.getId(), worker3.getId(), worker4.getId(), worker5.getId(), worker6.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds17), savedShift17.getId());
//
//            List<Long> userIds18 = List.of(worker6.getId(), worker7.getId(), worker8.getId(), worker9.getId(), worker10.getId());
//            shiftAssignmentService.assignShift("manager2", new ShiftAssignRequest(userIds18), savedShift18.getId());
//
//            List<Long> userIds19 = List.of(worker11.getId(), worker12.getId(), worker13.getId(), worker14.getId(), worker15.getId(), worker16.getId());
//            shiftAssignmentService.assignShift("manager1", new ShiftAssignRequest(userIds19), savedShift19.getId());
//
//            List<Long> userIds20 = List.of(worker17.getId(), worker18.getId(), worker19.getId(), worker20.getId(), worker1.getId(), worker2.getId(), worker3.getId());
